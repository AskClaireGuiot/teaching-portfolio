...
<main id="main-content" class="main" role="main">
  ...
  <section class="teaching-hero" aria-labelledby="teaching-title">
    <div class="teaching-hero-container">
      <h1 id="teaching-title" class="text-heading-1">Teaching</h1>
      <p class="text-body-large text-secondary">Teaching subtitle</p>
    </div>
  </section>

  <!-- Table of Contents -->
  <nav class="teaching-toc" aria-label="Page navigation" id="teaching-toc">
    <div class="teaching-toc-container">
      <div class="teaching-toc-header">
        <h2 class="text-heading-4">Contents:</h2>
        <button
          class="mobile-toc-toggle"
          aria-expanded="true"
          aria-controls="teaching-toc-list">
      ...
      <ul class="teaching-toc-list" id="teaching-toc-list">
        <li>
          <a href="#introduction" class="teaching-toc-link">Introduction</a>
        </li>
        <li>
          <a href="#teaching-activities" class="teaching-toc-link">Teaching Activities</a>
        </li>
        <li>
          <a href="#teaching-philosophy" class="teaching-toc-link">Teaching Philosophy</a>
        </li>
        <li>
          <a href="#teaching-strategies" class="teaching-toc-link">Teaching Strategies & Excellence</a>
        </li>
        <li>
          <a href="#educational-leadership" class="teaching-toc-link">Educational Leadership</a>
        </li>
        <li>
          <a href="#future-growth" class="teaching-toc-link">Future Growth</a>
        </li>
      </ul>
    </div>
  </nav>
